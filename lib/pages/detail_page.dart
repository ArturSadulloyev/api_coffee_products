...
import 'package:stajirovka_kofe/pages/shop_page.dart';
import '../main.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
              isLike ? CupertinoIcons.heart : CupertinoIcons.heart_fill,
              color: Colors.red,
            ),
          ),
          const SizedBox(
                          ...
                          onPressed: () {
                            if (count > 0) {
                              ...
                              cartController.addToCard(
                                  product: widget.products, quantity: -1);
                            }
                          },
                          icon: const Icon(
                            Icons.remove,
